...
const Footer = () => {
  return (
    <div>
      <footer className="mt-auto bg-neutral-950 w-full">
        <div className="mt-auto w-full max-w-[85rem] py-6 px-4 sm:px-6 lg:px-8 lg:pt-12 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <div className="col-span-full lg:col-span-1 mr-6">
              <Link
                to={"/"}
            ...
            <div className="col-span-1">
              <h4 className="font-semibold text-gray-100">Contact With Us</h4>
              ...
              <div className="mt-3 grid space-y-3">
                ...
                <p>
                  <a
                    ...
                    href="#"
                  >
                    Emali: foodiefiesta@gmail.com
                  </a>
                </p>
              </div>
            </div>
          </div>
          <div className="my-8 mx-auto md:w-[80%]">
            <h4 className="font-semibold text-center text-gray-100">
              Stay up to date
            </h4>
            <form>
              <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2">
                ...
                <a
                  className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#ED4C67] text-white hover:bg-[#B53471] disabled:opacity-50 disabled:pointer-events-none"
                  href="#"
                >
                  Subscribe
                </a>
          ...
          <div className="mt-5 sm:mt-12 flex justify-between items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400">
                © {new Date().getFullYear()} Comfort Bites. All rights reserved.
              </p>
            </div>
